...
if __name__ == '__main__':
    db = DB()  # 证券代码
    # 沪深300当日总市值
    sql_zsz = "SELECT sum(TOTMKTCAP)  FROM zgzb_zx.TQ_SK_FININDIC WHERE   TRADEDATE='20211209'   and  SYMBOL IN (SELECT DISTINCT (SAMPLECODE) FROM zgzb_zx.TQ_IX_COMP tic WHERE SYMBOL =000300 AND USESTATUS = 1);"
